...
class Chain():
	...
	Context is the absolute origin of an event. Context 0 is used for halogen itself while
	all contexts after that are reserved for clients.
	This same context id is used by Halogen Server to route response events to clients that
	sent it.
